            ...
            <TableBody>
              {data.map((blog) => (
                  <TableRow
                    ...
                    <TableCell>
                      <span className="text-base">{new Date(blog.createdDate).toLocaleDateString()}</span>
                    </TableCell>
                    <TableCell>
                      <span className="text-base">{new Date(blog.lastModifyDate).toLocaleDateString()}</span>
                    </TableCell>
                    <TableCell>
                      <div className="flex">
                        <Button
